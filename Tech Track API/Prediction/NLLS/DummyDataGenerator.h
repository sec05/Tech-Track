...
#ifndef TECH_TRACK_API_MODELS_NLLS_DUMMYDATAGENERATOR_H_
#define TECH_TRACK_API_MODELS_NLLS_DUMMYDATAGENERATOR_H_
...
#endif  // TECH_TRACK_API_MODELS_NLLS_DUMMYDATAGENERATOR_H_
